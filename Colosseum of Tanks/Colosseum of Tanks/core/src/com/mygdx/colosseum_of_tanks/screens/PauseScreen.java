...
public class PauseScreen implements Screen {
    ...
    public PauseScreen(TheGame game) {
        ...
        this.resumeButton = new TextButton("Resume game", skin, "small");
        this.restartButton = new TextButton("Restart game", skin, "small");
        this.saveButton = new TextButton("Save game state", skin, "small");
        this.exitButton = new TextButton("Exit to main menu", skin, "small");
