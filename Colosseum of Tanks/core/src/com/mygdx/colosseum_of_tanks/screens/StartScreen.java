...
public class StartScreen implements Screen {
    ...
    public StartScreen(TheGame game, int lastState) {
        ...
        this.skin = new Skin(Gdx.files.internal("uiskin/glassy-ui.json"));
        this.table = new Table();
        this.batch = new SpriteBatch();

        this.background1 = new Texture(Gdx.files.internal("images/infinite_background.jpg"));
        this.background2 = new Texture(Gdx.files.internal("images/infinite_background.jpg"));

        Label title = new Label("Colosseum of Tanks", skin, "black");
        this.newButton = new TextButton("New Game", skin, "small");
        this.continueButton = new TextButton("Continue", skin, "small");
        this.quitButton = new TextButton("Quit Game", skin, "small");
